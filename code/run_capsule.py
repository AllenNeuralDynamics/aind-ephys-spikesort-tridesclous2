...
parser = argparse.ArgumentParser(description="Spike sort ecephys data with Tridesclous2.")
...
min_drift_channels_help = (
    "Minimum number of channels to enable Tridesclous2 motion correction. Default is 96."
)
